...
<form action = "adminlogin.php" method="POST" role="form"> <!-- START OF FORM -->
<center>

<img src="login-img.png" alt="image" style = "float:left;margin-top:-11%;margin-left:1%;margin-right:1%; height:94%; width:50%">
<fieldset style="width: 45%; margin-top:14%;margin-bottom:7.7%;padding: 1.5%; background-color: #ff8c92; border-radius:3%;box-shadow: inset 0 0 10px #574d4f"> 

<h2 style="color:white;"><strong>Log in as Administrator</strong></h2>

<table>

<tr>
<td><h3 style="color:white;margin-left:-100%;"><b>Username</b></h3></td>
<td><input type = "text" name = "admin_username" required = "required" placeholder = "Email / Username"/> <!-- LOGIN USERNAME -->
			
</tr>

<tr>
<td><h3 style="color:white;margin-left:-100%;"><b>Password</b></h3></td>
<td><input type = "password" name = "admin_password" required = "required" placeholder = "Password"/> <!-- LOGIN PASSWORD -->
</tr>

<tr>
<td colspan="2"><input type="submit" name="admin_login" value="Login" style="margin-top:5%"/> <!-- LOGIN BUTTON -->
