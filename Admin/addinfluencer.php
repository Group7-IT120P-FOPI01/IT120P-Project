...
<center>
	...
	<h1 style="width: 45%; margin-top:10%;margin-bottom:5%; background-color: white;"> 
		...
		<h2 style="font-family: Copperplate Gothic; font-size: 60;color:#ff8c92;"><strong>Add New Influencer</strong></h2>
				...
				<div class="panel-body">
					...
					<form role="form" method="post">
						...
						<div class="form-group">
							...
							<label for="influencerID" style="font-family: Calibri; font-size: 130%">Influencer ID</label><br>
							<input type="text" class="form-control" style="border: 0; border-radius:10px; width: 20%; height: 4%; background-color:#fee9ea" name="influencerID" ><br><br>
						...
						<button onclick="myFunction()" type="submit" style="border: 0; border-radius:40px; width: 7%; height: 5%; font-family: Calibri; font-size: 160%; background-color:#ff8c92; color: white"class="btn btn-sm btn-primary" name="addinfluencer">Add Influencer</button>
...
<?php
    ...
    if(isset($_POST['addinfluencer']))
        { 
            ...
            $admin = mysqli_query($con, "INSERT INTO influencers (influencer_id, influencer_email, influencer_password, influencer_firstname, influencer_lastname, influencer_address) VALUES
			('$influencerID', '$email', '$password', '$fname', '$lname', '$address')"); 
